  ...
  return (
    <PlatformShell role="student" title="Мой план" subtitle={student.goalSummary}>
      <div className="metric-grid">
        ...
        <MetricCard label="Цель" value={student.targetGrade ?? "—"} detail={student.targetDate ?? "без даты"} />
      ...
      <Panel>
        ...
        <table className="data-table">
          <thead><tr><th>#</th><th>Дата</th><th>Тема</th><th>Цель</th><th>Skill atoms</th><th>Статус</th></tr></thead>
          <tbody>
